...
// Event Loop continously monitors the call stack,Call back queue and Microtask queue
// if call stack is empty then the in the call stack that callback function is executed
...
// Call back functions from setTimeouts and event listeners are mainly present in callback queue
// call backs from fetch and Mutation Observer are present in the microtask queue
